 ...
 *
 * This is used to define all hooks for the plugin.
 *
 ...
 * The plugin's loader class.
 *
 * This class is responsible for orchestrating the actions and filters
 * that occur within the plugin.
 *
 * @since      1.0.0
 * @package    SitemapXMLToPostsPages
 * @subpackage SitemapXMLToPostsPages/includes
 ...
 */
class Sitemap_XML_To_Posts_Pages_Loader {
